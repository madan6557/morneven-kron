...
- Validasi tanggal pembayaran hutang memakai riwayat pembayaran sebenarnya, bukan titik hitung bunga.
- Perbaikan arus kas hutang: pencairan hutang dan pemberian piutang kini ikut dihitung pada arus kas Beranda, Laporan, dan ekspor CSV. Sebelumnya hanya sisi pembayaran yang dihitung sehingga setiap hutang tampak sebagai kerugian sepihak dan setiap piutang sebagai keuntungan sepihak.
- Perbaikan ringkasan ekspor CSV: pemasukan terjadwal (tipe AUTOMATION) tidak lagi hilang dari total pemasukan, jumlah lampiran dihitung dari event yang diekspor, dan ditambahkan baris total pengeluaran keseluruhan serta arus kas bersih.
- Peringatan dana terbooking: dialog pengeluaran tak terduga dan pembayaran hutang kini memberi tahu bila transaksi akan memakai dana yang sudah dibooking ke budget, dan Main Vault minus ditampilkan pada Pusat perhatian di Beranda beserta cara menyelesaikannya.
